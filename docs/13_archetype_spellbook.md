...
Les valeurs carte par carte de cet archétype sont définies uniquement dans `MSE_projects/13_YGO_Spellbook.mse-set/`. Ce document ne conserve que les mots-clés d’affinité propres à l’archétype.

## Exception de coût alternatif

**High Priestess of Prophecy** conserve **Book Affinity** et imprime en plus un **Coût alternatif** carte-spécifique : « Révélez 3 “Spellbook” non-creature de votre main. » Cette exception reste en attente de validation dans `rule_reviews/2026-07-17-13-ygo-spellbook-rule-proposals.md` (D1).
