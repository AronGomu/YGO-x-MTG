...
('El Shaddoll Winda','B','Fusion Creature — Wizard','2 / 2','Fusion — 1 Shaddoll + 1 DARK', ['(1 - Passif) Chaque joueur ne peut invoquer spécialement qu’une fois par tour.','(2 - Déclenchable) **On Send GY** — Renvoyez une carte Shaddoll depuis votre cimetière dans votre main.']),
('Guardian Chimera','B','Fusion Creature — Beast','3 / 3','Fusion — 3 créatures avec des noms différents', ['(1 - Déclenchable) Si Guardian Chimera arrive, piochez deux cartes puis détruisez jusqu’à deux cartes ciblées.','(2 - Passif) Tant que vous avez une carte Fusion dans votre cimetière, Guardian Chimera a ward 2.']),
('Naturia Exterio','G','Fusion Creature — Beast','3 / 3','Fusion — Naturia Beast + Naturia Barkion', ['(1 - Activable Flash) Exilez une carte de votre cimetière : contrecarrez un sort non-créature ou une capacité non-créature ciblé.']),
...
('Thunder Dragon Colossus','W','Fusion Creature — Thunder','3 / 2','Fusion — 1 Thunder Dragon', ['(1 - Passif) Les adversaires ne peuvent pas chercher dans leur bibliothèque sauf en piochant.','(2 - Passif) Si Colossus devait être détruit, exilez une créature Thunder de votre cimetière à la place.']),
('Thunder Dragon Titan','R','Fusion Creature — Thunder','3 / 3','Fusion — 3 créatures Thunder', ['(1 - Déclenchable Soft) Si vous activez une capacité Thunder, détruisez une carte ciblée.','(2 - Passif) Si Titan devait être détruit, exilez deux cartes de votre cimetière à la place.']),
('Albion the Branded Dragon','W','Fusion Creature — Dragon','2 / 2','Fusion — Fallen of Albaz + 1 LIGHT', ['(1 - Déclenchable) Si Albion arrive, vous pouvez invoquer une Fusion Creature depuis votre extra deck en exilant ses matériaux depuis votre main, champ de bataille ou cimetière.','(2 - Déclenchable) **On Send GY** — Cherchez une carte Branded.']),
('Mirrorjade the Iceblade Dragon','B','Fusion Creature — Wyrm','3 / 3','Fusion — Fallen of Albaz + 1 Fusion/Synchro/Xyz/Link', ['(1 - Activable Flash Soft) Envoyez une Fusion Creature depuis votre extra deck au cimetière : exilez une créature ciblée.','(2 - Déclenchable) Si Mirrorjade quitte le champ de bataille, détruisez les créatures adverses à la prochaine étape de fin.']),
...
('Grapha, Dragon Overlord of Dark World','B','Fusion Creature — Fiend','3 / 3','Fusion — Grapha + 1 DARK', ['(1 - Activable Flash Soft) Quand un adversaire active un sort ou une capacité, transformez son effet en « votre adversaire se défausse d’une carte ».','(2 - Déclenchable) Si Grapha quitte le champ de bataille, renvoyez une créature Dark World depuis votre cimetière.']),
]
